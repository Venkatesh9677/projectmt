    ...
    <footer className="footer">
      <div className="container footer-container">
        <div className="footer-row">
          <div className="footer-identity">
            <a href="#home" className="navbar-brand nav-logo1">
             <span className="section-subtitle"> MUSCLE<span>TRAINER</span> </span> 
            </a>
          ...
          <div className="footer-feature">
            ...
            <div className="col">
              ...
              <ul className="footer-feature-list">
                <li>
                  <a href="#gmail">
                    <i className="ri-mail-line"></i> mt@gmail.com
                  </a>
                </li>
                <li>
                  <a href="#address">
                    <i className="ri-map-pin-line"></i> Virugambakkam
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div className="footer-copyright">
          @No-copywrites free for fair usage
        </div>
      </div>
    </footer>
  );
